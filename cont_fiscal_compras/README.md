...
6. `buscar_nuevo.php` consulta `saefprv`, une con `saefprv_iva_det` mediante `LEFT JOIN`, agrega retenciones desde `saeret` en las mismas celdas del comprobante y devuelve JSON para DataTables.
