...
7. El usuario puede exportar a Excel, CSV, impresión o PDF horizontal desde los botones de DataTables. En Excel/PDF, las celdas con varias retenciones conservan saltos de línea para que códigos, bases y valores retenidos no se descarguen concatenados.
...
- Exportar a Excel y verificar que las columnas `Código Retención`, `Valor Base Retención` y `Valor Retenido` mantengan los valores múltiples en líneas separadas dentro de la celda.
